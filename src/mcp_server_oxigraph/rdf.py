...
def oxigraph_add_many(quads: List[Dict[str, Any]], store_id: Optional[str] = None) -> Dict[str, Any]:
    """
...
def oxigraph_remove(quad: Dict[str, Any], store_id: Optional[str] = None) -> Dict[str, Any]:
    """
...
def oxigraph_remove_many(quads: List[Dict[str, Any]], store_id: Optional[str] = None) -> Dict[str, Any]:
    """
...
def oxigraph_clear(store_id: Optional[str] = None) -> Dict[str, Any]:
    """
